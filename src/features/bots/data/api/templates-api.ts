    ...
    switch (id) {
      case "lead-gen":
        return {
          nodes: [
            ...
            { id: "get-email", type: NodeType.ASK_QUESTION, label: "Ask Email", position: { x: 300, y: 1100 }, data: { message: "Thanks {{contact.full_name}}! What's the best email to reach you at?", variableName: "email", variableScope: "contact", inputType: "email", timeoutSeconds: 3600 }, branches: [{ key: "default", label: "Success" }] },
            { id: "thanks-lead", type: NodeType.SEND_TEXT, label: "Confirmation", position: { x: 300, y: 1400 }, data: { message: "Perfect! One of our experts will contact you at {{contact.email}} within 24 hours. Have a great day!" }, branches: [{ key: "default", label: "Default" }] },
      ...
      case "support-routing":
        return {
          nodes: [
            ...
            { id: "done", type: NodeType.SEND_TEXT, label: "Success", position: { x: 600, y: 1400 }, data: { message: "Thanks! A representative will be with you shortly. Your ticket ID is #{{session.id}}." }, branches: [{ key: "default", label: "Default" }] },
      ...
      case "customer-feedback":
        return {
          nodes: [
            { id: "start", type: NodeType.START, label: "Start Flow", position: { x: 500, y: 0 }, data: {}, branches: [{ key: "default", label: "Default" }] },
            { id: "greet", type: NodeType.SEND_TEXT, label: "Greeting", position: { x: 500, y: 250 }, data: { message: "👋 Hi! We value your business. Could you take a moment to rate your experience with us?" }, branches: [{ key: "default", label: "Default" }] },
            { 
              id: "nps", 
              type: NodeType.NPS, 
              label: "CSAT Rating", 
              position: { x: 500, y: 500 }, 
              data: { 
                message: "How would you rate your overall satisfaction?", 
                variableName: "satisfaction_score", 
            ...
            { id: "ask-feedback", type: NodeType.ASK_QUESTION, label: "Open Feedback", position: { x: 500, y: 800 }, data: { message: "Thank you for the {{session.satisfaction_score}} rating! Anything specific we can do to improve?", variableName: "comments", variableScope: "session", inputType: "text", timeoutSeconds: 3600 }, branches: [{ key: "default", label: "Success" }] },
            { id: "thank-you", type: NodeType.SEND_TEXT, label: "Thank You", position: { x: 500, y: 1100 }, data: { message: "We've received your feedback. Your rating of {{session.satisfaction_score}} and comments help us get better every day. Have a great day!" }, branches: [{ key: "default", label: "Default" }] },
            { id: "end", type: NodeType.END, label: "End", position: { x: 500, y: 1400 }, data: {}, branches: [] },
          ],
          edges: [
            { id: "e1", source: "start", target: "greet", sourceHandle: "default" },
            { id: "e2", source: "greet", target: "nps", sourceHandle: "default" },
            { id: "e3", source: "nps", target: "ask-feedback", sourceHandle: "default" },
            { id: "e4", source: "ask-feedback", target: "thank-you", sourceHandle: "default" },
            { id: "e5", source: "thank-you", target: "end", sourceHandle: "default" },
          ],
        };
      default:
        return {
